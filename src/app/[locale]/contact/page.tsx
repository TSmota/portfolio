  ...
  return (
    <main className="h-full bg-background text-foreground overflow-auto">
      <div className="flex-1 p-4 sm:p-6">
        <FileCommentHeader filename="contact.md" />
        ...
        <div className="grid gap-6 sm:gap-8 lg:grid-cols-2">
          {/* Contact Information */}
          <div>
            <SectionHeader icon="📞" title={t('info.title')} />

            <div className="space-y-4">
              <ContactInfoCard
                icon="📧"
                label={t('email.label')}
                value="thiago.mota2000@outlook.com"
                href="mailto:thiago.mota2000@outlook.com"
              />
              <ContactInfoCard
                icon="📱"
                label={t('phone.label')}
                value="+55 (11) 97780-3063"
                href="tel:+5511977803063"
              />
              <ContactInfoCard
                icon="📍"
            ...
            <div className="mt-8">
              <h3 className="text-lg sm:text-xl font-semibold mb-4 flex items-center gap-2">
                <span>🌐</span> {t('social.title')}
              </h3>
              <div className="flex gap-3 sm:gap-4">
                <SocialLink
                  href="https://github.com/tsmota"
                  label="GitHub"
                  icon={
                ...
                />
                <SocialLink
                  href="https://www.linkedin.com/in/thiago-mota-silva/"
                  label="LinkedIn"
                  icon={
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
